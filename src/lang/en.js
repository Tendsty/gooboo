...
export default {
  ...
  message: {
    ...
    unlock: {
      card: 'New card pack!',
      general: 'New questline!',
      treasure: 'New treasure effect!',
      book: 'New book!',
    },
    update: {
      get: 'New update!',
  ...
  prestigeFormula: {
    gallery_cash: 'CASH = 10^(log8(BEAUTY / 100B)^0.7)',
  },
  confirm: {
    ...
    cardShinyPack: {
      0: 'You are about to buy the shiny card pack ',
      1: ', which costs rare currency. Are you sure you want to buy this?'
    },
    ...
    schoolExamPass: 'You do not have enough exam passes, but can buy them with sapphires. Are you sure you want to do this?',
    relicGlyph: 'Changing your pedestals resets the current level progress for all glyphs. Are you sure you want to do this?',
    ...
    buyDiamondForge: 'You are about to spend diamonds on a relic. Are you sure you want to do this?',
  ...
  text: {
    ...
    hordeLootElementalEssence: 'Loot elemental essence',
    hordeRespawnFaster: 'Enemies respawn twice as fast',
    farmBonusDna: '+5 DNA',
    farmUnlockDna: 'Unlock a DNA upgrade with the effects of all level 1 genes you did not choose',
    farmGnomeBoost: 'Increase all harvest gain by 4% for each nearby garden gnome (6% for premium gnomes)',
    farmLonelyGrow: 'Grow 30% faster and gain +150% overgrow if no other crops of this type are on the field',
    ...
    farmSelfless: 'Increase yield by +3% for all crops (stacks up to +30%)',
  ...
  info: {
    ...
    cheater: {
      ...
      50: {
        title: 'Curious',
        description: 'Used tools to predict future outcomes',
      },
      100: {
        title: 'Automated',
      ...
      150: {
        title: 'Savescummer',
        description: 'Used tools or the save / load function to predict future outcomes and make purchase decisions or alter outcomes based on this information',
      },
      200: {
        title: 'Cheater',
        description: 'Edited game variables or used tools to achieve otherwise impossible results',
      },
  ...
  school: {
    ...
    buyPass: {
      0: 'If you attempt an exam without enough passes, they will be bought automatically for ',
      1: ' each',
    },
    library: 'Library',
    practice: 'Practice',
    ...
    examDustFull: 'Your ancient hourglass is full! You\'ll get bonus dust instead of golden dust, which needs time to become ready for use.',
    examDustOvercap: 'Your ancient hourglass is almost full. Some golden dust gained from this exam could get converted to bonus dust.',
    answer: 'Answer',
    ...
    math: {
      ...
      description: 'Answer various equations to raise your score. Gain 1 score for each correct answer, and lose 5 seconds for each wrong answer. As your grade increases, numbers get bigger and new operators are introduced.',
    },
    literature: {
      name: 'Literature',
    ...
    history: {
      ...
      description: 'Remember the displayed dates and find matching pairs (up to 5) to raise your score. Not finding a pair for a date you have seen before takes away 5 seconds. As your grade increases, years get bigger and more years are added.',
      newGame: 'New game, new years! Get ready...',
      year: 'Year',
    ...
    art: {
      name: 'Art',
      subtitle: 'Mix colors',
      description: 'Guess colors correctly to raise your score. Two colors will be displayed, guess the result from mixing them. Gain 1 score for each correct answer, and lose 5 seconds for each wrong answer. As your grade increases, more answers get added and the answers get more similar.',
    },
    chemistry: {
      name: 'Chemistry',
      subtitle: 'Observe experiments',
      description: 'Watch an experiment with different shapes. After the experiment, a question is asked and you need to estimate the answer. As your grade increases, more shape and question types get added, and your answer needs to be more precise.',
      newGame: 'New game, new experiment! Get ready...',
      questionShape: {
        0: 'How many ',
        1: '?',
      },
      questionSize: {
        text: 'How many {0} shapes?',
        0: 'small',
        1: 'average-sized',
        2: 'large',
      },
      questionSpin: {
        text: 'How many shapes are {0}?',
        0: 'spinning counter-clockwise',
        1: 'not spinning',
        2: 'spinning clockwise',
      },
      questionMoveRandom: {
        text: 'How many shapes are {0}?',
        0: 'not moving',
      ...
      questionMoveDirection: {
        text: 'How many shapes are moving {0}?',
        0: 'horizontally',
        1: 'vertically',
        2: 'diagonally',
      },
    ...
    book: {
      name: 'Book',
      get: 'You get this book when you reach {0} grade, or by accumulating {1} total points',
      buy: {
        0: 'You can also click to gain this book instantly for ',
        1: '',
      },
      skipped: 'You spent {0} emeralds to get this book early, you\'ll get them back when you reach {1} grade, or by accumulating {2} total points',
      scalesWithGL: 'Scales with global level',
      scalesUpTo: 'up to {0}',
      read: 'Read',
    }
  },
  hourglass: {
    ...
    bonusTitle: 'Bonus dust',
    bonusDescription: 'Golden dust above capacity will be gained as bonus dust instead. Each second, you convert 1 bonus dust into golden dust.',
  },
  cryolab: {
    ...
    expDescription2: 'Experience gain is based on global level gained from this feature ({0}).',
    expNext: 'Next level effect:',
    expNoGain: 'To gain experience for this feature, gain some prestige currency first',
    expFormula: 'EXP = 1.015^GL * GL * 2',
    nextLevelTime: 'Reaching the next level takes {0}',
    cropExp: 'Gain up to this amount of experience for each crop (higher base grow time reduces experience gained). This is then multiplied by the difference between highest and current crop level (crops at their highest level get no experience)',
    frozenFeature: {
  ...
  general: {
    ...
    questHighestAmount: 'Highest {0} amount',
    ...
    grobodal: {
      ...
      searchingTheArchives: 'Searching the archives',
      gardening: 'Gardening',
      pitchBlack: 'Pitch black',
      masterOfTheSystem: 'Master of the system',
      thinkPlayerThink: 'Think, player, think!',
      discoveringTheMystery: 'Discovering the mystery',
      prettyAndPeaceful: 'Pretty and peaceful',
  ...
  event: {
    ...
    nightHunt: {
      ...
      newDescription: {
        ...
        isNewNoToken: 'This is a new recipe',
  ...
  settings: {
    ...
    general: {
      ...
      showDetailedPatchnotes: {
        name: 'Show detailed patchnotes'
      },
      showAllCards: {
        name: 'Show all cards'
      },
      showEfficiencyStats: {
        name: 'Show efficiency stats'
      }
    },
    automation: {
      name: 'Automation',
  ...
  statBreakdown: {
    ...
    miningObsidianPenalty: 'Enhancement penalty',
    ...
    hordeEquipmentPermanent: 'Equipment effect',
    ...
    hordeClassLowerLimit: 'Lower limit',
    ...
    hordeRaid: 'Raid victory',
    hordeSkeleton: 'Skeleton',
    hordeEnemyActive: 'Enemy active',
    farmEarlyGame: 'First crops',
    farmGiantCrop: 'Giant crop',
    ...
    grouped: 'Grouped ({0})',
    generalBonusCompletions: 'Relic battery',
  },
  ...
  mining: {
    ...
    rareEarthDescription: {
      ...
      limestone: 'Can be found at any depth that is a prime number. You receive less scrap on depths where limestone is present',
      moonshard: 'Can be found at {0}m or below if the depth dweller has reached that depth',
      phosphorus: 'Can be found at {0}m or below if the depth is divisible by 25. You receive no smoke on depths where phosphorus is present',
    },
    ...
    enhancement: {
      title: 'Enhancements',
      description: 'Use bars to apply enhancements to your pickaxe. Each bar has its own unique enhancement that can be applied multiple times.',
      disableDescription: 'You can temporarily disable all enhancements to gather obsidian again, but you\'ll get less obsidian based on the amount of enhancements applied',
      maximumDescription: 'You can only have a limited amount of enhancements, so think about which ones you put on your pickaxe.',
  ...
  horde: {
    ...
    critDescription: 'Regular attacks have a chance to deal increased damage. Crit chance can reach values over 100%, in which case the attack damage gets increased multiple times',
    ...
    divisionShieldReplenishDescription: 'Replenish {0}% of your missing division shield after defeating an enemy',
    ...
    hasteDescription: 'Reduces the cooldown of combat actives',
    hasteFormula: 'CD = BASE_CD / (1 + HASTE / 100)',
    ...
    raidboss: 'Raid boss',
    rareLoot: 'Rare loot',
    rareLootDescription: 'Every few minutes, defeated enemies drop rare loot.',
    ...
    statusResist: 'Recover faster from status effects',
    ...
    rampage: {
      ...
      effect: 'Each time an enemy rampages, it gets x{0} attack, +{1} status resist and becomes immune to attack reducing effects.',
      effectCurrent: 'This enemy has rampaged {0} times. It has x{1} attack and {2} status resist.'
    },
    sigil: {
      name: 'Sigil',
      ...
      executing: 'Executing',
      raidRage: 'Raid rage',
      monstrousToughness: 'Monstrous toughness',
      berserk: 'Berserk',
      iceGiant: 'Ice giant',
      generic: 'Generic',
    },
    ...
    equipment: {
      ...
      inactive: 'Inactive combat actives recover their cooldown at {0}% of the usual rate',
      ...
      critCore: 'Crit core',
      heavyGauntlet: 'Heavy gauntlet',
      dumbbell: 'Dumbbell',
      essenceExtractor: 'Essence extractor',
      spellbook: 'Spellbook',
      forbiddenScissors: 'Forbidden scissors',
      basicSpear: 'Basic spear',
      cursedEye: 'Cursed eye',

      // Blessed equipment
      blessedSword: 'Blessed sword',
      blessedArmor: 'Blessed armor',
      blessedBow: 'Blessed bow',
      blessedFlame: 'Blessed flame',
      blessedWater: 'Blessed water',
      blessedShield: 'Blessed shield',
    ...
    active: {
      ...
      addStack: 'Raise the stats of this equipment (until prestige)',
      baseValue: 'base',
    },
    heirloom: {
      name: 'Heirloom',
      ...
      boost: {
        name: 'Heirloom boost',
        description: 'Your boost level for this heirloom is {0}, increasing its effect (^{1}):',
      },
      min: 'Appears at zone {0} or higher',
      special: 'Does not appear on rare loot',
      description: 'Heirlooms are powerful artifacts that can be found from rare loot and stay forever. Reach higher zones to find more types',
    ...
    itemMastery: {
      name: 'Mastery',
      description: 'Defeat bosses or gain rare loot at zone {0} or higher with this equipment to earn mastery points. Higher zones earn more mastery points.',
      ...
      4: 'The active is 1.5x stronger, and disabling the active gives a +{1}% boost instead of +{0}%',
      5: 'Can collect up to {0} mystical shards. This value is increased by another {1} for each mastery'
    },
    raid: {
      title: 'Raid',
      name: 'Raids',
      description: 'Raids are special places that require a raid key to enter. Challenge powerful raid bosses to raise your stats and permanently improve your heirlooms',
      keyDescription: 'Get {0} raid keys when defeating a raid boss for the first time, and get {1} raid keys per day (next ones in {2})',
      victory: 'Raid victory',
      victoryDescription: 'You have defeated {0} raid bosses, increasing your stats until prestige. For each defeated raid boss, you gain:',
      raidbossDescription: 'Defeating a raid boss increases your raid key capacity and increases the difficulty of future raid bosses. The current raid boss is about as strong as a zone {0} boss. Stronger raid bosses give better heirloom boosts when defeated.',
      raidbossFail: 'Failing to defeat the raid boss gives you the rewards of the previous raid boss instead.',
      fight: 'Fight',
      slay: 'Slay',
      slayAll: 'Slay all',
      slayDescription: 'Use a raid key to gain all rewards from the strongest defeated raid boss without having to fight. If you did not pick an heirloom boost from the last raid victory, a random one will be chosen.',
      slayConvert: 'This happens automatically if you gain more raid keys than you can hold.',
    },
    element: {
      elementalUpgrade: '{0} element',
      elementalStats: '{0} upgrade',
      enemyStats: 'Enemy stats',
      enemyActive: 'Enemy actives',
      enemyActiveDescription: 'Improves the power of enemy actives, and new ones unlock at 0, 20, 35 and 50',
    ...
    classes: {
      level: 'Class level',
      levelDescription: 'Gain class levels over time, increasing your blood gain, blood capacity and courage gain. You also get {0} skill points per class level.',
      skill: 'Skill',
      ...
      stanceClick: 'Stance - click to change',
      skillName: {
        energyConvert: 'Energy conversion',
        stab: 'Stab',
        combatHeal: 'Combat heal',
        brawl: 'Brawl',
        spark: 'Spark',
        smash: 'Smash',
        ...
        energyOnCrit: 'Energy surge',
        longshot: 'Longshot',
        eagleEye: 'Eagle eye',
        fireArrows: 'Fire arrows',
        poisonArrow: 'Poison arrow',
        healOnCrit: 'Rejuvenation',
        reduceCooldownOnCrit: 'Relentlessness',
        bloodOnCrit: 'Taste of blood',
        shockArrow: 'Shock arrow',
        sharpArrow: 'Sharp arrow',
        sharpMind: 'Sharp mind',
        forestBlessing: 'Blessing of the forest',
        ...
        damageRamp: 'Rising damage',
        heavyHit: 'Heavy hit',
        shieldBash: 'Shield bash',
        statRamp: 'Rising power',
        refuge: 'Refuge',
        ...
        challenge: 'Challenge',
        parrotAttack: 'Parrot attack',
        plunder: 'Plunder',
        bottleOBrew: 'Bottle o\' brew',
        bombToss: 'Bomb toss',
        cannonball: 'Cannonball',
        invigoratingBottle: 'Invigorating bottle',
        treasureChest: 'Treasure chest',
        bountyBoard: 'Bounty board',
        pirateShip: 'Pirate ship',

        sneak: 'Sneak',
        elementOfSurprise: 'Element of surprise',
        backstab: 'Backstab',
        smokeBomb: 'Smoke bomb',
        comboStrike: 'Combo strike',
        cursedDagger: 'Cursed dagger',
        swiftStrike: 'Swift strike',
        shuriken: 'Shuriken',
        knockout: 'Knockout',
        hiddenExplosive: 'Hidden explosive',
        herbTea: 'Herb tea',
        ...
        lootingStance: 'Looting stance',
        learningStance: 'Learning stance',
        crimsonPact: 'Crimson pact',
        crimsonRitual: 'Crimson ritual',
        reincarnation: 'Reincarnation',
        crimsonCurse: 'Crimson curse',
        sacrificialDagger: 'Sacrificial dagger',
        crimsonHeart: 'Crimson heart',
        despair: 'Despair',
        drainLife: 'Drain life',
        hex: 'Hex',
        darkRitual: 'Dark ritual',
        occultRestoration: 'Occult restoration',
        harvest: 'Harvest',
        summonAbomination: 'Summon abomination',
        occultThunder: 'Occult thunder',
      },
      adventurer: {
        name: 'Adventurer',
    ...
    battlePass: {
      ...
      bossDoubleReward: 'Boss quests advance the battle pass by 2 levels',
    },
    enemyName: {
      soldier: 'Soldier',
    ...
    area: {
      ...
      zone: 'Zone {0}',
      digsite: 'Digsite',
      digsiteDescription: 'Defeat powerful skeleton bosses to unlock the ability to find monster teeth in this area.',
      digsiteWeakness: 'This skeleton is weak to the {0} class, using any other class gives the skeleton x{1} attack and health.',
      digsiteWeaknessTitle: 'Skeleton weaknesses',
      digsiteWeaknessShort: 'Weak to {0}',
    ...
    sign: {
      ...
      sign_2: {
        text: 'Think you can hurt me? Never! I\'ll dodge everything, you won\'t even be able to hit me! I\'m untouchable!',
        signed: 'ohilio',
      },
      sign_3: {
  ...
  farm: {
    ...
    prestige: {
      description: 'You can prestige a crop that has reached level 4, increasing its prestige level to its current level for bonuses. This will reset all experience, level and genes for that crop. Each prestige level multiplies yield for all crops by x1.04.',
      current: 'Your current prestige level is {0}, multiplying yield by x{1}.',
      next: 'Prestiging this crop increases your prestige level by {0}. This raises your total prestige level to {1}, increasing your yield to x{2}.',
      ...
      noMoreGL: 'After reaching level 40, crops stop increasing global level',
    },
    button: {
      ...
      delete: 'Remove a crop from a tile. Resources spent are refunded',
      deleteBuilding: 'Decoration can also be removed this way and is returned to your inventory',
    ...
    overgrowDescription: 'After fully growing, your plants can keep growing to increase all harvest gain. Grow time is multiplied by {0}x for each 100% reached.',
    ...
    specialCropEffect: 'Reach the next level to gain:',
    freeUpgrades: {
      s: 'gene left',
      p: 'genes left'
    },
    ...
    crop: {
      ...
      ancientFern: 'Ancient fern',
    },
    giantCrop: {
      name: 'Giant crop',
      regular: 'You are currently planting regular crops',
      giant: 'You are currently planting giant crops',
      clickToToggle: 'click to toggle',
      description: 'You can plant giant crops for bigger harvests. They have modified stats:',
      stat: {
        0: 'Grow time increased from {0} to {1}',
        1: 'Fertilizer cost increased from {0} to {1}',
        2: 'All harvest gain x{0}',
        3: 'Crop cost x{0}',
        4: 'Experience gain x{0}',
      },
      efficiency: 'This giant crop is {0}% time-efficient',
    },
    gene: {
      name: 'Gene',
      upgrade: 'Gene upgrade',
      pickLevel: 'Pick a level {0} gene',
      dnaDescription: 'You get 1 DNA when this crop reaches a new level and can spend it on gene upgrades',
    ...
    building: {
      ...
      sprinkler: {
        name: 'Sprinkler',
        description: 'Crops in the same row grow +{0}% faster and have +{1}% overgrow',
        care: 'Care is more likely to appear',
      },
      lectern: {
        name: 'Lectern',
        description: 'Crops in the same column give +{0}% experience',
      },
      pinwheel: {
        name: 'Pinwheel',
        description: 'Multiplies rare drop chance on the entire field for each unique crop in the surrounding 8 tiles, for a maximum of {0}x',
        rareDrop: 'Multiplies rare drop chance on the entire field',
      },
      flag: {
        name: 'Flag',
        description: 'Increases yield by +{0}% if they are in the correct position related to the flag. Vegetable: Top left, Berry: Top right, Grain: Bottom left, Flower: Bottom right',
      }
    },
    care: {
      wateringCan: 'Watering can',
      description1: 'Care appears on regular crops over time as long as the watering can holds rainwater. Up to a total of {0} crops can have care active at once. Hover over the watering can icon on the crop to apply care.',
      description2: 'Rainwater accumulates at a rate of up to {0}/h and has a base capacity of {1}. Rainwater keeps accumulating above that value, but at a slightly reduced rate.',

      empty: 'The watering can is completely empty. Wait for a bit until more care can appear.',
      low: 'The watering can is almost empty. Rainwater accumulates at full speed, and care appears very slowly.',
      mid: 'The watering can holds a bit of water. Rainwater accumulates at close to full speed, and care appears slowly.',
      half: 'The watering can holds a lot of water. Rainwater accumulates at medium speed, and care appears at an average rate.',
      high: 'The watering can is almost full. Rainwater accumulates at low speed, and care appears fast.',
      full: 'The watering can is full. Rainwater accumulates very slowly, and care appears very fast.',

      improve: 'Care type improved: {0}',
      add: 'Care type added: {0}',
      disable: 'Care type disabled: {0}',
  ...
  gallery: {
    ...
    shapes: {
      ...
      special: {
        ...
        accelerator: 'The surrounding 8 shapes are special collected. If all 8 of them are the same, spend up to 100 motivation to gain even more shapes',
  ...
  gem: {
    newGemsTime: 'Gain new rubies and emeralds every time the bar fills. The generator creates new gems every {0}.',
    newGemsTimeAchievement: 'Gain new rubies and emeralds every time the bar fills. Each achievement increases generation speed by +{0}%. Your {1} achievements increase generation speed by +{2}%, from {3} to {4}.',
    newGemsTimeSecondary: 'Gain new secondary gems every time the bar fills. The generator creates new gems every {0}.',
    newGemsTimeAchievementSecondary: 'Gain new secondary gems every time the bar fills. Each achievement increases generation speed by +{0}%. Your {1} achievements increase generation speed by +{2}%, from {3} to {4}.',
    newDiamondTime: 'Gain a diamond every time the bar fills. The generator creates diamonds every {0}.',
    diamondForge: 'Diamond forge',
  },
  achievement: {
    nextReward: 'This is given as a reward when completing the next level of this achievement.',
    secret: 'This achievement is secret and does not give any bonuses.'
  },
  treasure: {
    effectSummary: 'Effect summary',
    effectOwned: 'You own {0} treasures with this effect',
    effectMax: 'Only the strongest {0} treasures apply ({1} / {0})',
    effectMinTier: 'This effect only appears on treasures with tier {0} or higher',
    eventPowerDescription: 'Event power cannot be gained by buying treasure, it needs to be added to existing treasure using a specific modifier. Each point of event power increases prestige gain for all features by +0.15%, and your event power is limited to 20% of your global level.',
    eventPowerEffect: 'Your event power multiplies all prestige gain by x{0}',
    eventPowerOvercap: 'You have {0} more event power than needed to reach the limit',
    upArrowFragments: 'Adding this modifier increases fragments gained when deleting this treasure by {0}',
    expanderFragments: 'Adding this modifier reduces the level to 0, refunds fragments spent and increases fragments gained when deleting this treasure by {0}',
    expanderEffect: 'Upgrades to level {0} in a month and level {1} in a year',
    level: 'Level',
    tier: 'Tier',
