export default {
  ...
  miningBeaconPiercing: '锋利信标',
  miningBeaconRich: '富有信标',
  miningBeaconWonder: '奇妙信标',
  ...
  villageIngredientCount: '可找到的原料',
  villageIngredientBoxAmount: '每个箱子的原料',
  ...
  nightHuntIngredientSize: '成分分量',
  nightHuntFavouriteIngredientSize: '偏好成分分量',
  nightHuntMaxIngredients: '仪式成分',
  nightHuntBonusIngredientCount: '奖励成分种类',
  ...
  nightHuntRitualFamiliarity: '仪式熟练度',
  snowdownAttack: '攻击',
  snowdownHealth: '生命值',
  snowdownDefense: '防御',
  ...
  snowdownAllAttack: '全部攻击力',
  snowdownAllHealth: '全部生命值',
  snowdownAllDefense: '全部防御力',
  snowdownRevengeStats: '复仇统计数据',
