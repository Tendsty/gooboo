...
export default {
    ...
    currency: {
        // Permanent upgrades
        ruby: {color: 'red', icon: 'mdi-rhombus'},

        // Replacable items (semi-permanent)
        emerald: {color: 'green', icon: 'mdi-hexagon'},

        // Instant or temporary boosts
        sapphire: {color: 'indigo', icon: 'mdi-pentagon'},

        // Cosmetic items
        amethyst: {color: 'purple', icon: 'mdi-cards-diamond'},

        // Event currency
        topaz: {color: 'amber', icon: 'mdi-triangle', overcapMult: 0, capMult: {round: true, baseValue: 1000}},
