...
export default {
    ...
    redPower: {cap: 15, capMult: true, requirement() {
        ...
        {name: 'currencyGalleryBeautyGain', type: 'mult', value: lvl => splicedPowLinear(1.25, 0.25, 15, lvl)}
    ]},
    ...
    orangePower: {cap: 15, capMult: true, requirement() {
        ...
        {name: 'currencyGalleryRedGain', type: 'mult', value: lvl => splicedPowLinear(1.25, 0.25, 15, lvl)}
    ]},
    ...
    yellowPower: {cap: 15, capMult: true, requirement() {
        ...
        {name: 'currencyGalleryOrangeGain', type: 'mult', value: lvl => splicedPowLinear(1.25, 0.25, 15, lvl)}
    ]},
    ...
    greenPower: {cap: 15, capMult: true, requirement() {
        ...
        {name: 'currencyGalleryYellowGain', type: 'mult', value: lvl => splicedPowLinear(1.25, 0.25, 15, lvl)}
    ]},
    ...
    bluePower: {cap: 15, capMult: true, requirement() {
        ...
        {name: 'currencyGalleryGreenGain', type: 'mult', value: lvl => splicedPowLinear(1.25, 0.25, 15, lvl)}
    ]},
    ...
    purplePower: {cap: 15, capMult: true, requirement() {
        ...
        {name: 'currencyGalleryBlueGain', type: 'mult', value: lvl => splicedPowLinear(1.25, 0.25, 15, lvl)}
    ]},
