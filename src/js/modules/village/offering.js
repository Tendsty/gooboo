...
export default {
    ...
    knowledge: {unlock: 'villageOffering4', amount: 20, cost: lvl => Math.pow(1.25, lvl) * 250, effect: 2},
    science: {unlock: 'villageOffering4', amount: 20, cost: lvl => Math.pow(1.25, lvl) * 100, effect: 1},
    joy: {unlock: 'villageOffering4', amount: 20, cost: lvl => Math.pow(1.25, lvl) * 750, effect: 5},
}
