...
export default {
    bookAluminiumHardening: {type: 'book', requirement() {
    ...
    bookAluminiumTanks: {type: 'book', requirement() {
    ...
    bookRefinery: {type: 'book', requirement() {
    ...
    bookFurnace: {type: 'book', requirement() {
    ...
    bookIronExpansion: {type: 'book', requirement() {
    ...
    bookMagnet: {type: 'book', requirement() {
    ...
    bookMetalDetector: {type: 'book', requirement() {
