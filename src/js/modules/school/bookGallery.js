...
export default {
    bookRedPower: {type: 'book', requirement() {
    ...
    bookOrangePower: {type: 'book', requirement() {
    ...
    bookYellowPower: {type: 'book', requirement() {
    ...
    bookGreenPower: {type: 'book', requirement() {
    ...
    bookBluePower: {type: 'book', requirement() {
    ...
    bookPurplePower: {type: 'book', requirement() {
